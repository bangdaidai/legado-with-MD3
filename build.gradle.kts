...
val verifyConfigArchitecture = tasks.register<VerifyConfigArchitectureTask>(
    ...
    legacyPreferenceCallBaseline.set(
        mapOf(
            ...
            "io/legado/app/data/repository/HomeDashboardRepository.kt" to 4,
            ...
            "io/legado/app/ui/book/search/SearchViewModel.kt" to 4,
            "io/legado/app/ui/config/otherConfig/OtherConfigViewModel.kt" to 0,
