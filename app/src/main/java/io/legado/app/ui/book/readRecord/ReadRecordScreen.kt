                ...
                actions = {
                    if (inSelectionMode) {
                        ...
                        val (icon, description) = when (displayMode) {
                            ...
                            DisplayMode.LATEST -> Icons.Default.HourglassBottom to
                                    stringResource(R.string.a11y_switch_to_duration_view)

                            DisplayMode.DURATION -> Icons.AutoMirrored.Filled.List to
