...
internal fun Preferences.toCoverSettings(): CoverSettings = CoverSettings(
    ...
    centerInfo = compatDsBoolean(PreferKey.coverCenterInfo) ?: false,
...
internal fun CoverSettings.toPrefMap(): Map<String, Any?> = mapOf(
    ...
    PreferKey.coverCenterInfo to centerInfo,
...
internal fun Preferences.toAppShellSettings(): AppShellSettings = AppShellSettings(
    ...
    navIconSize = compatDsInt(PreferKey.navIconSize) ?: 40,
...
internal fun AppShellSettings.toPrefMap(): Map<String, Any?> = mapOf(
    ...
    PreferKey.navIconSize to navIconSize,
...
internal fun Preferences.toThemeSettings(): ThemeSettings = ThemeSettings(
    ...
    enableStatusBarBlur = compatDsBoolean(PreferKey.enableStatusBarBlur) ?: true,
    ...
    largeContainerNineSliceLight = compatDsString(PreferKey.largeContainerNineSliceLight),
    largeContainerNineSliceDark = compatDsString(PreferKey.largeContainerNineSliceDark),
    itemNineSliceLight = compatDsString(PreferKey.itemNineSliceLight),
    itemNineSliceDark = compatDsString(PreferKey.itemNineSliceDark),
    largeContainerNineSliceScale = compatDsFloat(PreferKey.largeContainerNineSliceScale) ?: 1f,
    itemNineSliceScale = compatDsFloat(PreferKey.itemNineSliceScale) ?: 1f,
...
internal fun ThemeSettings.toGatewayPrefMap(): Map<String, Any?> = mapOf(
    ...
    PreferKey.enableStatusBarBlur to enableStatusBarBlur,
