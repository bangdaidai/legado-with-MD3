...
object PreferKey {
    ...
    const val coverCenterInfo = "coverCenterInfo"
    ...
    const val bookshelfTicketDotted = "bookshelfTicketDotted"
    ...
    const val readingMemorySortBy = "readingMemorySortBy"
    const val readingMemoryGroupBy = "readingMemoryGroupBy"
    const val readingMemoryOnlyWithReview = "readingMemoryOnlyWithReview"
    const val readingMemoryShowIntro = "readingMemoryShowIntro"
    const val readingMemoryShowReview = "readingMemoryShowReview"
    ...
    const val largeContainerNineSliceLight = "largeContainerNineSliceLight"
    const val largeContainerNineSliceDark = "largeContainerNineSliceDark"
    const val itemNineSliceLight = "itemNineSliceLight"
    const val itemNineSliceDark = "itemNineSliceDark"
    const val largeContainerNineSliceScale = "largeContainerNineSliceScale"
    const val itemNineSliceScale = "itemNineSliceScale"
    ...
    const val allowSameNameAuthorType = "allowSameNameAuthorType"
